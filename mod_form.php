...
/**
 * The main mod_medalhasproitec configuration form.
 *
...
class mod_medalhasproitec_mod_form extends moodleform_mod
{
    ...
    public function definition()
    {
        ...
        $mform->addElement('text', 'name', get_string('medalhasproitecname', 'mod_medalhasproitec'), ['size' => '64']);
        ...
        $mform->addHelpButton('name', 'medalhasproitecname', 'mod_medalhasproitec');
